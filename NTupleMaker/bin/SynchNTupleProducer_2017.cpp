...
int main(int argc, char * argv[]){
  ...
  const bool  applyTauId     = true; //cfg.get<bool>("ApplyTauId");
  const bool  applyMuonId     = true' //cfg.get<bool>("ApplyMuonId");//merijn 2019 8 8: make sure that the flag in the config is used
